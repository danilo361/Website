    ...
    <main>
      ...
      <section>
        ...
        <div id="divalinha">
          ...
          <form name="form-editar" class="formpage" method="post" action="./posts.php">
            <h1 id="h1">Editar postagem</h1>

            <input type="text" name="titulo" class="intextarea" value="<?= $titulo; ?>" required />
            <label for="titulo" class="lable-inferior">Título</label>

            <input type="text" name="autor" class="intextarea" value="<?= $autor; ?>" />
